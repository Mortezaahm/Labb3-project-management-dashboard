      ...
      <main className="flex-1">
        ...
        <section className="container mx-auto px-4 py-32">
          ...
          <div className="flex flex-row items-center justify-center gap-3">
            <Link href="/register">
            <button className="bg-black text-white rounded-lg px-4 py-1 hover:bg-blue-900 cursor-pointer">Join today</button>
            </Link>
            <Link href="/login">
            <button className="bg-black text-white rounded-lg px-4 py-1 hover:bg-blue-900 cursor-pointer">Log in</button>
            </Link>
            </div>
