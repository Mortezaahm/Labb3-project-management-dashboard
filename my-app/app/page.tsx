                ...
                <>
                    <section className="container mx-auto px-4 py-32">
                        ...
                        <div className="flex flex-col items-center justify-center gap-4">
                            ...
                            <p className="text-gray-600 dark:text-white">
                                Your projects are waiting. Join us for free
                                today.
                            </p>
                        </div>
                    ...
                    <section className="container mx-auto px-4 md:pt-16">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-12 max-w-4xl mx-auto px-4">
                            <CardFeature
                                title="Projects"
                                description="Creating projects with TaskFlow is simple and quick."
                                icon={BookOpen}
                            />
                            <CardFeature
                                title="Edit"
                                description="When plans change, TaskFlow has you covered. Easily update your task."
                                icon={Zap}
                            />
                            <CardFeature
                                title="Deadlines"
                                description="Done with a task? TaskFlow let's you mark it as done to help you keep track of your progress."
                                icon={CheckCircle}
                            />
                        </div>
                    </section>
